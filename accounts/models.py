...
class UserProfile(models.Model):
    ...
    user_type = models.CharField(_('User Type'), choices=user_type_category, max_length=10, default='Client')
    ...
    picture = models.ImageField(_('Picture'), blank=True, upload_to='picture/%Y/%m/%d/')
    fb_url = models.URLField(_('Facebook'), blank=True, max_length=100)
    tw_url = models.URLField(_('Twitter'), blank=True, max_length=100)
    gh_url = models.URLField(_('GitHub'), blank=True, max_length=100)
